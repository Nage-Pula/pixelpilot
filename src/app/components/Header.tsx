  ...
  return (
    <header className="relative z-50 w-full px-1 pt-6 pb-3 bg-transparent">
      ...
      >
        ...
        {/* Nav Links -- hidden below 500px */}
        <div className="hidden min-[500px]:flex flex-1 flex-wrap justify-center gap-x-2 gap-y-2 sm:gap-x-3 md:gap-y-5">
          {navLinks.map(({ href, label }) => (
            <Link
              ...
              className={`
                ...
                ${pathname === href
                  ? "bg-white text-black scale-110 -translate-y-2 shadow-2xl border-2 border-orange-200 z-20 font-extrabold"
                  : "opacity-95"
                }
              `}
        ...
        {/* Hamburger menu for mobile (below 500px) */}
        <button
          type="button"
          className="block min-[500px]:hidden text-orange-500 text-3xl p-2 ml-auto"
      ...
      {/* Mobile Drawer */}
      {menuOpen && (
        <div className="fixed inset-0 w-full min-h-screen z-[9999] bg-black/95 flex flex-col transition-all duration-300 min-[500px]:hidden">
